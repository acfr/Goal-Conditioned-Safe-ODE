...
def get_fitness_loss(model, 
    ...
    ''' 
    loss function as equation (35) in the paper, 
    with hinge loss and different treatment for obstacle and non-obstacle points. 
    For obstacle points, we want the model output to be greater, 
    and for non-obstacle points, we want the model output to be less.
    '''
    @jax.jit
